    ...
    <div className="app-container" style={{ padding: 0 }}>
      ...
      <div className="code-viewer-container">
        <div className="code-header">
          <h2 className="screen-title" style={{ margin: 0 }}>Código ESP32</h2>
        ...
        <p className="screen-subtitle">Copie este código para a IDE do Arduino, compile e grave no seu ESP32.</p>
